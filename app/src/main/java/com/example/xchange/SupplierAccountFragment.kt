 ...
 * Use the [SupplierAccountFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SupplierAccountFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SupplerAccountFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SupplierAccountFragment().apply {
